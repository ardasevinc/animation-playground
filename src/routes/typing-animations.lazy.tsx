...
import { RewritingTextAnimationCard } from '@/components/rewriting-text-animation-card';
    ...
    <main className='flex-1 flex flex-col gap-y-20'>
      <section className='w-full'>
        <div className='bg-muted rounded-lg p-2 lg:p-10'>
          <h2 className='text-center text-2xl'>Typing Animations</h2>
        </div>
      </section>
